  ...
  try {
    ...
    const updatedMedication = await prisma.medication.update({
      ...
      data: {
        ...
        times: timesString,
        startDate: data.startDate ? new Date(data.startDate) : existingMedication.startDate,
        endDate: data.endDate ? new Date(data.endDate) : null,
        isActive: data.isActive !== undefined ? data.isActive : existingMedication.isActive,
        photoUrl: data.photoUrl !== undefined ? data.photoUrl : existingMedication.photoUrl,
      },
      include: {
        user: {
          select: {
